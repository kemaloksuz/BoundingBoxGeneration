#! /usr/bin/env bash
CONFIG1="rpn_r50_fpn_MaskAware_05_wc2_wr1";
CONFIG2="rpn_r50_fpn_MaskAware_05_wc1_wr05";
...
python tools/test.py "configs/softIoU/MaskAwareIoU/RPN/$CONFIG2.py" "work_dirs/$CONFIG2/epoch12.pth" --out "results/RPN/$CONFIG2/$CONFIG2.pkl" --eval proposal_fast >> "results/RPN/$CONFIG2/$CONFIG2.result"
