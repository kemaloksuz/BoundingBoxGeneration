from .assigners import AssignResult, BaseAssigner, MaxIoUAssigner,MaxDIoUAssigner,MaxGIoUAssigner, MaxSoftIoUAssigner, MaxMaskAwareIoUAssigner, MaxSoftIoUConditionalAssigner
