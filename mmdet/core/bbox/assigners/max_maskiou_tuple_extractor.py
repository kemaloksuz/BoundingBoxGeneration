...
from ..geometry import bbox_overlaps, segm_overlaps, segm_iou, mask_aware_bbox_overlaps
...
class MaxMaskAwareIoUTupleExtractor(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None, gt_masks=None):
        ...
        segm_rate = mask_aware_bbox_overlaps(gt_masks, gt_bboxes, bboxes, self.maskIOUweight)
        ...
        segm_rates = segm_rate[indexes[:,0], indexes[:,1]]
